const data = [
  ...
  },
  {
    ...
    answer:
      "Payment is divided into 3. An initial 30% upfront payment to get me started once all the details of the project is set, 40% once the project is completed, and 30% once the project is delieverd.",
  },
  {
    id: 4,
